...
languages["en"]["maternal-screen-use-and-patterns-of-breastfeeding-title"] = `Maternal Screen Use and Patterns of Breastfeeding: A Population-Based Canadian Study.`;
languages["en"]["maternal-screen-use-and-patterns-of-breastfeeding-description"] = `Garon-Carrier, G., <b>Tiraboschi, G. A.</b> , Julien, C., Vézina, F., Leroux-Maurais, D., Bernard, J. Y., ... & Fitzpatrick, C. (2026).`;
languages["en"]["digital-cultures-and-the-exposome-of-psychosis-title"] = `Digital cultures and the exposome of psychosis`;
languages["en"]["digital-cultures-and-the-exposome-of-psychosis-description"] = `Werst, M. J. A., <b>Tiraboschi, G. A.</b>, &amp; Paquin, V. (2026). Digital cultures and the exposome of psychosis. <i>Schizophrenia Research</i>, 293, 109&ndash;112.`;
languages["en"]["no-effect-of-expectancy-on-visuospatial-attention-in-brief-cognitive-training-with-action-video-games-title"] = `No Effect of Expectancy on Visuospatial Attention in Brief Cognitive Training with Action Video Games`;
languages["en"]["no-effect-of-expectancy-on-visuospatial-attention-in-brief-cognitive-training-with-action-video-games-description"] = `Gon&ccedil;alves, E., <b>Tiraboschi, G. A.</b>, Fukusima, S. S., &amp; de Moraes, R. (2026). No Effect of Expectancy on Visuospatial Attention in Brief Cognitive Training with Action Video Games. <i>Journal of Cognitive Enhancement</i>.`;
...
languages["en"]["internet-anxiety-2023-title"] = `Adolescent internet use predicts higher levels of generalized and social anxiety symptoms for girls but not boys`;
...
languages["en"]["society-for-research-development-title"] = `Bidirectional Associations Between Video Game Playing and ADHD Symptoms Among School-Aged Children`;
languages["en"]["society-for-research-development-description"] = `Poster presented at the Society for Research in Child Development. Minneapolis, United States`;
...
languages["en"]["postdoctoral-fellow-mcgill-title"] = `Postdoctoral Fellow`;
languages["en"]["postdoctoral-fellow-mcgill-date"] = `2026 - present`;
languages["en"]["postdoctoral-fellow-mcgill-description"] = `Lead quantitative and qualitative projects focusing on digital interventions and digital media policy for youth.`;
languages["en"]["postdoctoral-fellow-mcgill-location"] = `<strong>McGill University, Montreal, Canada</strong>`;
languages["en"]["postdoctoral-fellow-title"] = `Postdoctoral Fellow`;
languages["en"]["postdoctoral-fellow-date"] = `2022 - 2026`;
...
languages["en"]["postdoctoral-fellow-location"] = `<strong>Université de Sherbrooke, Quebec, Canada</strong>`;
